...
// FIX: Add new import for checking the content type
...
public class TextUtil {
    ...
    private static void buildMarkdownRecursively(Text part, StringBuilder markdownBuilder) {
        // 1. 处理当前节点的内容和样式
        // FIX: Use the more robust, version-agnostic way to get literal content.
        String content = "";
        if (part.getContent() instanceof LiteralTextContent) {
            // This is the correct way to get the string from a literal text component.
            content = ((LiteralTextContent) part.getContent()).string();
        }
